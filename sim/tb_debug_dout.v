...
module tb_debug_dout;
    ...
    always @(posedge clk) begin
        if (sel_formatter && u_formatter.state == 3) begin  // WAIT_READ2
            $display("T=%0t WAIT_READ2: ram_addr_a=%0d ram_dout=0x%02x (%c) line_len=%0d", 
                     $time, ram_addr_a, ram_dout, ram_dout, u_formatter.line_len);
        end
    end
